	...
	$.fn.jqGalScroll = function(options){
		...
		return this.each(function(i){
			...
			.each(function(j){
				...
				var $a = $('<a href="#'+(j)+'" class="'+selected+'" title="'+j+'"></a>').click(function(){
				...
				image.onload = function(){
					...
					image.onload = null;
					$loader.fadeOut();
					jqimg.css({marginLeft:-image.width*.5,marginTop:-image.height*.5,position:'absolute',left:'50%',top:'50%'}).fadeIn(1000);
					var alt = jqimg.attr('alt');
					//if(typeof alt != 'undefined'){
						//$titleHolder.text(alt).fadeIn(1000);
					//}
				};
