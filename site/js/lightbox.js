...
(function(jQuery) {
	...
	jQuery.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			'images/site/loadding.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			'images/site/prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			'images/site/hinhanh/next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			'images/site/hinhanh/close.gif',		// (string) Path and the name of the close btn
			imageBlank:			'images/site/blank.gif',			// (string) Path and the name of a blank image (one pixel)
			// Configuration related to container image box
			containerBorderSize:	10,			// (integer) If you adjust the padding in the CSS for the container, #lightbox-container-image-box, you will need to update this value
			containerResizeSpeed:	400,		// (integer) Specify the resize duration of container image. These number are miliseconds. 400 is default.
			// Configuration related to texts in caption. For example: Image 2 of 8. You can alter either "Image" and "of" texts.
			txtImage:				'Hình',	// (string) Specify text "Image"
		...
		function _show_image_data() {
			...
			if ( settings.imageArray.length > 1 ) {
				jQuery('#lightbox-image-details-currentNumber').html(settings.txtImage + ' ' + ( settings.activeImage + 1 ) + ' ' + settings.txtOf + ' ' + settings.imageArray.length + ' TRANGDIAOC.VN').show();
			}		
		}
		/**
