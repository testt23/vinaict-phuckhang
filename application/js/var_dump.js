function var_dump () {
    ...
    if (d.body) {
        ...
        try {
            ...
            console.log('<pre xmlns="http://www.w3.org/1999/xhtml" style="white-space:pre;">' + output + '</pre>');
        } catch (e) {
            console.log(output); // Outputting as plain text may work in some plain XML
        }
    }
}
