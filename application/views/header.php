<?php $this->session->set_userdata('url_lang',curPageURL()); ?>	
		...
		<div id="sitename">
			<a href="<?php echo base_url(); ?>" class="logo float-left" title="<?php echo getI18n(SITE_NAME); ?>"><?php echo getI18n(SITE_NAME); ?></a>
                        ...
                        ?>
                            <a href="<?php echo base_url(); ?>/login/lang/?lang=<?php echo $lang[$i] ?>" class="float-right"><img style="width: 24px; height: 24px;" src="<?php echo base_url(); ?>/images/icons/<?php echo $lang[$i] ?>.png" /></a>
		        <?php 
                                } 
                            } 
                        ?>
