...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname = SMTP_EMAIL)
{
      ...
      $admin_email         = SMTP_EMAIL;//User duoc khai bao tren mail server
      $smtp_username     = SMTP_USER;//User duoc khai bao tren mail server
      $smtp_password     = SMTP_PASS;//Pass cua email nay
